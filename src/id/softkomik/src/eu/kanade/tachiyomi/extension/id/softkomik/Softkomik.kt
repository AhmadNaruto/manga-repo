...
class Softkomik : HttpSource() {
    ...
    // Optimized for performance: converted internal DTOs and route classes
    // to regular classes to reduce generated bytecode size.
    ...
    // Internal route representation for session handling
    private class SessionRoute(
        val key: String,
